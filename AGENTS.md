...
- Canonical repo target: `kotlin-textwrap`. Useful entrypoints: `dev project show kotlin-textwrap`, `dev build kotlin-textwrap`, `dev check kotlin-textwrap`.
- Setup-managed files are regenerated with `dev setup kotlin-textwrap`; avoid hand-editing stamped generated files.
